...
\usepackage[margin=15mm]{geometry}%margins; tweak for printer deficiencies
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%General: Audio and Acoustic Signal Processing, Array Signal Processing \\
%Detailed: Binaural Source Localization, Spatial Audio, Active Noise Control, HRTF (Head-Related Transfer Function) Measurement and Modelling, Virtual Acoustics and Surround Sound Systems
...
%\emph{``Sound control and noise reduction over space"}, Chair of Multimedia Communications and Signal Processing, University of Erlangen-Nuremberg, Erlangen, Germany, July 2016.
%
%\item \textsc{\textbf{Seminar}},
%\emph{``Spatial sound and multi-zone reproduction"}, Center of Intelligent Acoustics and Immersive Communications, Northwestern Polytechnical University, Xi'an, China, April 2016.
%
%
%\item \textsc{\textbf{Paper Presentation}},
%\emph{``Functional analysis guided approach for sound field reproduction with flexible loudspeaker layouts"}, at 2013 IEEE Workshop on Applications of Signal Processing to Audio and Acoustics (WASPAA), New Paltz, NY, USA, Oct. 2013.
%
%\item \textsc{\textbf{Seminar}},
...
%\begin{itemize}
%%
%\item \textsc{\textbf{Editorial board member}}, Advances in Signal Processing, Horizon Research Publishing (HRPUB), 2013-present.
%\item \textsc{\textbf{Editorial board member}}, Science Journal of Circuits, Systems and Signal Processing, 2013-present.
%\item \textsc{\textbf{Affiliate member}}, IEEE Signal Processing Society Technical Committee on Audio and Acoustic Signal Processing, 2013-present.
...
%\item \textsc{\textbf{TPC Member}}, IEEE Joint Workshop on Hands-free Speech Communication and Microphone Arrays (HSCMA), 2014.
%\item \textsc{\textbf{TPC Member}}, IEEE Workshop on Applications of Signal Processing to Audio and Acoustics (WASPAA), 2015.
%\item \textsc{\textbf{TPC Member}}, European Signal Processing Conference (EUSIPCO), 2016.
%
...
%
%\item Reviewer of IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP), 2014-2016.
%\item Reviewer of European Signal Processing Conference (EUSIPCO), 2012-2016.
...
%
%\item Visit to Prof. Walter Kellermann, Chair of Multimedia Communications and Signal Processing, University of Erlangen-Nuremberg, Erlangen, Germany, July 2016.
%
%\item Visit to Prof. Jingdong Chen, Center of Intelligent Acoustics and Immersive Communications, Northwestern Polytechnical University, Xi'an, China, March-May 2016.
%\item Visit to A/Prof. Ramani Duraiswami, Perceptual Interfaces and Reality Laboratory, UMIACS,
%University of Maryland, College Park, USA, Apr. 2008.
%\item Visit to Dr. Mark Poletti, Gracefield Research Centre, Industrial Research Limited, Lower Hutt, New
%Zealand, July 2007.
%\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\begin{itemize}
%%
%\item \textsc{\textbf{Training}}, \textbf{Foundation of University Teaching and Learning, Centre for Higher Education}, Learning and Teaching, ANU, Oct.-Nov. 2012.
%
%\item \textsc{\textbf{Training}}, The Graduate Teaching Programme, Research Student Development Centre, ANU,
%June-Oct. 2006.
%
%\item \textsc{\textbf{Teaching: Course Coordinator/Lecturer}}, Advanced Topics in Telecommunications (ENGN 8637)---Audio and Speech Signal Processing, CECS, ANU, July-Oct. 2013.
%
%\item \textsc{\textbf{Teaching: Lecturer}}, Discrete-time Signal Processing (ENGN 4537/6537), CECS, ANU, Feb-Jun. 2013-2015.
%
%\item \textsc{\textbf{Teaching: Course Coordinator}}, Individual Project (ENGN 4200), CECS, ANU, 2016-present.
%
%\end{itemize}
%
%\section*{Honours and R\&D Student Supervision}
%
%\begin{itemize}
%
%\item \textsc{\textbf{BE R\&D Student}}, Mr. Paul Apelt, ``\emph{Surround Sound Reproduction}", CECS, 2016.
%
%\item \textsc{\textbf{BE R\&D Student }}, Mr. Usman Khan, ``\emph{Enabling Sound Localization in the Median Plane through Statistical Correlation Modelling}", CECS, 2014.
%
%\item \textsc{\textbf{BE Honours Student}}, Mr. Yucheng Liu, ``\emph{Binaural Dereverberation and Localization in the Median Plane}", CECS, 2015.
%
%\item \textsc{\textbf{BE Honours Student}}, Mr. Yizhou Yang, ``\emph{Room Acoustic Simulation Using Finite Element Method}", CECS, 2015.
%
%\item \textsc{\textbf{BE Honours Student}}, Ms. Wang Xi, ``\emph{Personal Sound Zones}", CECS, 2014.
%
%\item \textsc{\textbf{BE Honours Student}}, Ms. Menglu Pei, ``\emph{Multichannel Speech Dereverberation}", CECS, 2014.
%
%\item \textsc{\textbf{BE Honours Student}}, Ms. Tianhang Zhu, ``\emph{Direction of Arrival Estimation using Sparse Arrays}", CECS, 2014.
%
%\item \textsc{\textbf{BE Honours Student}}, Mr. Boning Li, ``\emph{Noise Reduction and Speech Enhancement}", CECS, 2013.
%
%\item \textsc{\textbf{BE Honours Student}}, Mr. Chenwei Cui, ``\emph{2.5D Sound Field Reproduction Employing Circular Loudspeaker Arrays}", CECS, 2013.
%
%\item \textsc{\textbf{BE Honours Student}}, Ms. Faning Wu, ``\emph{Broadband DOA Estimation using Eigenbeam Processing}", CECS, 2013.
%
%\item \textsc{\textbf{BE Honours Student}}, Ms. Guangyang Zhang, ``\emph{Beamforming for Smart Antenna Systems}", CECS, 2013.
%
%\item \textsc{\textbf{ME Honours Student}}, Mr. Yanting Liu, ``\emph{Modal Domain Calibration-based Dereverberation}", CECS, 2014.
%
%\item \textsc{\textbf{ME Honours Student}}, Mr. Libin Zhang, ``\emph{HRTF Individualization in the Horizontal Plane}", CECS, 2013.
%
%\end{itemize}
%
%\section*{HDR Student Supervision}
%
%\begin{itemize}
%
%\item \textsc{\textbf{PhD Student}}, Mr. Dumidu Talagala (co-supervisor), ``\emph{Array Signal Processing Algorithms for Localization and Equalisation in Complex Acoustic Channels}", ANU, 2012-2013.
%
%\item \textsc{\textbf{PhD Student}}, Mr. Hanchi Chen (co-supervisor), ``\emph{Active Noise Cancellation}", ANU, 2013-present.
%
%\item \textsc{\textbf{PhD Student}}, Mr. Xiang Wu (co-supervisor), ``\emph{Binaural Source Separation and Localization}", ANU, 2013-present.
%
%\item \textsc{\textbf{PhD Student}}, Mr. Fei Ma (main supervisor), ``\emph{Acoustic Channel Modelling and Estimation}", ANU, 2015-present.
%
%\end{itemize}
